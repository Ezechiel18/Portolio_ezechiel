# =========================
# SCRIPT PYQGIS - TERRASSES - ANALYSE DE SENSIBILITÉ
# =========================
# Auteur : Ezéchiel
...
for PENTE_FAIBLE_MAX in PENTE_FAIBLE_LIST:
    for PENTE_FORTE_MIN in PENTE_FORTE_LIST:
        ...
        # =========================
        # 5. VECTORISATION PENTES FAIBLES
        # =========================
...
for i in range(len(results)):
    for j in range(i + 1, len(results)):
        ...
        if (pf1 == pf2 and pF1 != pF2) or (pf1 != pf2 and pF1 == pF2):
            ...
            print(f"{pf1}/{pF1} vs {pf2}/{pF2} → Jaccard = {round(jaccard,3)}")
